...
def setupTest():
    ...
    su.setTokens(accessToken=accessToken, refreshAuthorizationToken=refreshToken)
    syrup.setupDBs()
    ms.seedMerchants()
    return
...
# curtisCardHolderID = su.getCardHolderID(email="clx@gmail.com")
...
print(syrup.calculateMonthlyTopThreeCategories(syrup._accessToken,test_CardHolderID, test_AccountID))
